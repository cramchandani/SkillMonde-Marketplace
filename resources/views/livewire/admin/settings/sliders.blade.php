                    ...
                    <ul class="!grid !grid-cols-12 sm:!gap-x-6 gap-y-6 !m-auto fileuploader-items-list">
                        ...
                        @foreach (sliders() as $img)
                            <li
                                ...
                                class="!col-span-12 sm:!col-span-6 md:!col-span-4 lg:!col-span-3 !w-full h-36 !m-auto fileuploader-item file-type-image file-ext-png file-has-popup rounded-[6px]" style="height:100px;">
