        ...
        <nav class="relative container max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 justify-between items-center h-20 flex" style="max-width: 94%;">
            ...
            <div class="inline-flex items-center min-w-fit">
                ...
                @if (Cookie::get('dark_mode') === 'enabled' && settings('general')->logo_dark)
                    <a href="{{ url('/') }}" class="block ltr:sm:mr-6 rtl:sm:ml-6">
                        <img width="200" height="{{ settings('appearance')->sizes['header_desktop_logo_height'] }}" src="{{ src(settings('general')->logo_dark) }}" alt="{{ settings('general')->title }}" style="height: {{ settings('appearance')->sizes['header_desktop_logo_height'] }}px;width:auto">
                    </a>
                @else
                    <a href="{{ url('/') }}" class="block ltr:sm:mr-6 rtl:sm:ml-6">
                        <img width="200" height="{{ settings('appearance')->sizes['header_desktop_logo_height'] }}" src="{{ src(settings('general')->logo) }}" alt="{{ settings('general')->title }}" style="height: {{ settings('appearance')->sizes['header_desktop_logo_height'] }}px;width:auto">
                    </a>
                @endif
            ...
            <div class="min-w-fit ltr:sm:ml-10 rtl:sm:mr-10 flex items-center font-medium text-sm transition-all duration-200">
                        ...
                        <div class="bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 rounded divide-y divide-gray-100 dark:divide-zinc-400">
                            <div class="p-2 space-y-1">
                                ...
                                @endif
                                 ...
                                 {{-- Explore sellers --}}
                                <a href="{{ url('sellers') }}" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                    <span>@lang('messages.t_explore_sellers')</span>
                                </a>
                ...
                @guest
                    ...
                    {{--
                    <a href="https://skillmonde.com/auth/register" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 px-4 hidden md:block dark:text-gray-100 dark:hover:text-white">
                        @lang('messages.t_become_a_seller')
                    </a>
                    --}}
                @endguest
                ...
                {{-- Post a Project --}}
                @guest
                    <a href="{{ url('post-project') }}" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 px-4 hidden md:block dark:text-gray-100 dark:hover:text-white">
                    ...
                    <div 
                        ...
                        <div class="bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 rounded divide-y divide-gray-100 dark:divide-zinc-400">
                            <div class="p-2 space-y-1">
                                ...
                                {{-- Sign in --}}
                                <a href="{{ url('auth/login') }}" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                    <span>@lang('messages.t_sign_in')</span>
                                </a>
                                
                                 {{-- Join --}}
                                <a href="{{ url('auth/register') }}" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                ...
                @foreach ($categories as $category)
                    <li class="inline-block flex-shrink-0 border-b-2 border-transparent hover:border-primary-600 focus:outline-none focus:ring-0 relative">
                        ...
                        @if (count($category->subcategories))
                            <button data-popover-target="popover-subcategories-{{ $category->uid }}" data-popover-trigger="hover" class="block text-[13px] font-semibold text-gray-700 dark:text-gray-300 dark:group-hover:text-white group-hover:text-primary-600 py-2 focus:outline-none focus:ring-0 text-white">
                                {{ $category->name }}
                            </button>
                        @else
    ...
    @foreach ($categories as $category)
        ...
        <div data-popover id="popover-subcategories-{{ $category->uid }}" data-popover-placement="bottom" role="tooltip" class="absolute z-10 invisible inline-block w-64 text-sm font-light text-gray-500 transition-opacity duration-300 bg-white rounded-md shadow-xl opacity-0 dark:text-zinc-400 dark:bg-zinc-800 max-h-80 overflow-y-auto">
              <ul class=" !overflow-y-auto scrollbar-thin scrollbar-thumb-primary-600 scrollbar-track-white dark:scrollbar-track-zinc-800">
                @foreach ($category->subcategories as $sub)
                    <li class="first:rounded-t-md">
                        <a href="{{ url('categories/' . $category->slug . '/' . $sub->slug) }}" class="flex items-center py-1 px-3 hover:bg-gray-50 dark:hover:bg-zinc-700" style="border-radius: inherit">
            ...
            <div class="bg-gray-50 dark:bg-zinc-700 rounded-b-md text-center browse secondary-btn">
                <a href="{{ url('categories', $category->slug) }}" class="block px-1 py-2 text-white dark:text-zinc-300 hover:text-primary-600 hover:underline text-xs tracking-wide font-semibold">
            ...
            <div 
                ...
                <div @class(['w-full overflow-auto h-full', 'pt-5' => auth()->check()])>
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        @auth
                            @if (auth()->user()->account_type === 'seller')
                                <a href="{{ url('seller/orders') }}" class="text-white hover:text-primary-600 dark:text-gray-100 dark:hover:text-white transition-colors duration-300 py-2 mx-4 relative md:hidden">
                    ...
                    {{-- Sign in --}}
                    @guest
                        <a href="{{ url('auth/login') }}" class="py-2 px-5 block text-white dark:text-gray-200 font-semibold text-sm">
                    ...
                    @if (auth()->guest() || ( auth()->check() && auth()->user()->account_type !== 'seller' ))
                        <a href="{{ url('start_selling') }}" class="py-2 px-5 block text-white dark:text-gray-200 font-semibold text-sm">
                            @lang('messages.t_become_a_seller')
                        </a>
                    @endif

                    {{-- Explore gigs --}}
                    <a href="{{ url('search') }}" class="py-2 px-5 block text-white dark:text-gray-200 font-semibold text-sm">
                        ...
                        <div 
                            ...
                            class="relative z-0">
                                ...
                                <nav class="mt-1.5 ltr:ml-8 rtl:mr-8 flex flex-col">
                                    ...
                                    {{-- Explore gigs --}}
                                    <a href="{{ url('search') }}" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-white hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                        <span>@lang('messages.t_explore_gigs')</span>
                                    </a>
    
                                    {{-- Explore projects --}}
                                    @if (settings('projects')->is_enabled)
                                        <a href="{{ url('explore/projects') }}" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-white hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                            <span>@lang('messages.t_explore_projects')</span>
                                        </a>
                                    @endif
                                    
                                     {{-- Explore sellers --}}
                                    <a href="{{ url('sellers') }}" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-white hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                        <span>@lang('messages.t_explore_sellers')</span>
                                    </a>
                                </nav>
                    </div>
                    ...
                    {{-- Home --}}
                    <a href="{{ url('/') }}" class="py-2 px-5 flex items-center text-white dark:text-gray-200 font-semibold text-sm">
                    ...
                    {{-- Contact us --}}
                    <a href="{{ url('help/contact') }}" class="py-2 px-5 flex items-center text-white dark:text-gray-200 font-semibold text-sm">
