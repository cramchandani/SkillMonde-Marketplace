        ...
        <div class="grow">
            ...
            <div class="flex items-center mt-1">
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-sm text-gray-500 dark:text-gray-300">{{ $total_bids }} {{ strtolower(__('messages.t_bids')) }}</span>
                </div>
                ...
                <div class="flex items-center ltr:ml-4 ltr:pl-4 ltr:border-l rtl:mr-4 rtl:pr-4 rtl:border-r border-gray-300 dark:border-zinc-600">
                    ...
                    @if ($budget_type === 'fixed')
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_fixed_price') }}</span>
                    @elseif(($budget_type === 'hourly'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_hourly_price') }}</span>
                    @elseif(($budget_type === 'per_minute'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_minute_price') }}</span>
                    @elseif(($budget_type === 'per_second'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_second_price') }}</span>
                    @elseif(($budget_type === 'per_word'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_word_price') }}</span>
                    @elseif(($budget_type === 'per_unit'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_unit_price') }}</span>
                    @elseif(($budget_type === 'per_chapter'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_chapter_price') }}</span>
                    @elseif(($budget_type === 'per_book'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_book_price') }}</span>
                    @elseif(($budget_type === 'per_cover'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_cover_price') }}</span>
                    @elseif(($budget_type === 'per_question'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_question_price') }}</span>
                    @elseif(($budget_type === 'per_course'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_course_price') }}</span>
                    @elseif(($budget_type === 'per_art_image'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_art_image_price') }}</span>
                    @elseif(($budget_type === 'per_video'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_video_price') }}</span>
                    @elseif(($budget_type === 'per_animation'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_animation_price') }}</span>
                    @elseif(($budget_type === 'per_page'))
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_page_price') }}</span>
                    @else
                        <span class="text-sm text-gray-500 dark:text-gray-300">{{ __('messages.t_per_others_price') }}</span>
                    @endif
                ...
                <div class="flex items-center ltr:ml-4 ltr:pl-4 ltr:border-l rtl:mr-4 rtl:pr-4 rtl:border-r border-gray-300 dark:border-zinc-600">
                    ...
                    <span class="text-sm text-gray-500 dark:text-gray-300">{{ $created_at }}</span>
                </div>
