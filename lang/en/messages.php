<?php
    ...
    return [
        ...
        "t_create_gig_faq_subtitle"                                => "Add Questions & Answers for your clients",
        "t_add_faq"                                                => "Add FAQ",
        "t_answer"                                                 => "Answer",
        ...
        "t_create_gig_requirements_subtitle"                       => "Get all the information you need from clients to get started",
        ...
        "t_get_noticed_by_right_buyers_images"                     => "Get noticed by the right clients with visual examples of your services",
        "t_images"                                                 => "Images",
        ...
        "t_capture_buyer_attention_with_video"                     => "Capture clients' attention with a video that showcases your service",
        "t_video"                                                  => "Video",
        ...
        "t_resubmit_requirements_success_msg"                      => "You can now send new required sinformation to freelancer",
        ...
        "t_learn_how_to_create_an_outstanding_service_experience"  => "Learn how to create an outstanding service experience for your clients and grow your career as an online freelancer in our platform",
        "t_gig"                                                    => "Gig",
        ...
        "t_buyer_didnt_send_requirements_yet_continue"             => "We are waiting for the client to submit the requirements, until then the countdown for this order will not start",
        "t_cancel"                                                 => "Cancel",
        ...
        "t_deliver_completed_work_subtitle"                        => "Submit the completed work to the client",
        ...
        "t_u_have_to_select_deliverd_work_or_quick_response"       => "You must either upload a completed work or enter a quick response for the client",
        ...
        "t_buyers_will_see_ur_message_when_visiting_ur_gigs"       => "Clients will see your message when visiting your gig on profile page",
        ...
        "t_information_u_requested_from_buyer"                     => "List of information you requested from the client below",
        "t_no_upgrades_selected"                                   => "No upgrades selected",
        "t_buyer_didnt_selected_any_upgrades_or_no_upgrades"       => "Client did not select any upgrades or gig does not have one",
        "t_buyer"                                                  => "Client",
        "t_contact"                                                => "Contact",
        ...
        "t_buyer_purchases"                                        => "Client purchases",
        ...
        "t_enter_maximum_purchases_for_buyer"                      => "Enter maximum purchases for client",
        "t_enter_minimum_purchases_for_buyer"                      => "Enter minimum purchases for client",
        ...
        "t_catch_buyers_eyes_with_nice_img"                        => "Catch clients eyes with a nice image",
        ...
        "t_set_required_info_to_get_from_buyer"                    => "Set the required info the client will provide after buy this gig",
        ...
        "t_request_refund_subtitle"                                => "We recommend you always to contact the freelancer before request a refund",
        ...
        "t_buyer_has_canceled_order"                               => ":client has canceled an order",
        "t_buyer_sent_u_message_about_delivered_files"             => ":client sent you a message about delivered files",
        "t_order_id_completed"                                     => "Order :id has been completed",
        "t_new_message_about_refund"                               => "You have new message about a refund",
        "t_a_refund_has_closed"                                    => ":client has closed a refund",
        "t_buyer_opened_new_refund_dispute"                        => ":client has opened a new refund dispute",
        ...
        "t_subject_seller_delivered_work_new_msg"                  => "New delivered work message from client",
        ...
        "t_notification_seller_line_1_refund_request"              => "A client requested a refund for an item, click button below to see refund details",
        "t_notification_seller_line_1_refund_closed"               => "A client has closed a refund, click button below to see the refund details",
        ...
        "t_notification_seller_line_1_order_canceled"              => "client has canceled an order item, click button below to see order details",
        "t_notification_seller_line_1_new_refund_msg"              => "You have a new message about a refund from the client, click button below to see refund details",
        ...
        "t_this_is_why_buyer_requested_refund"                     => "This is why the client requested refund",
        "t_item_gig"                                               => "Item gig",
        ...
        "t_help"                                                   => "Help",
        "t_featured_categories"                                    => "Skill Categories",
        ...
        "t_order_placed_waiting_offline_payment"                   => "You order has been placed, once we receive a payment you will be able to submit the required info to client",
        ...
        "t_buyer_stories"                                          => "Client stories",
        "t_buyer_story_1"                                          => "SkillMonde is an amazing resource for anyone in the startup space.",
        "t_buyer_story_2"                                          => "People love our logo, and we love SkillMonde.",
        "t_buyer_story_3"                                          => "There is no way I could have produced anything without SkillMonde.",
        ...
        "t_how_much_money_can_i_make_answer"                       => "It's totally up to you. You can work as much as you want. Many freelancers work on SkillMonde full time and some keep their 9-5 job while using SkillMonde to make extra money.",
        "t_how_much_does_it_cost_question"                         => "How much does it cost?",
        "t_how_much_does_it_cost_answer"                           => "It's free to join SkillMonde. There is no subscription required or fees to list your services. You keep 80% of each transaction.",
        ...
        "t_how_do_i_price_my_service_answer"                       => "You can set your pricing anywhere from ₹50- 100,000 and offer your service to clients.",
        "t_how_do_i_get_paid_question"                             => "How do I get paid?",
        "t_how_do_i_get_paid_answer"                               => "Once you complete a client's order, the money is transferred to your account. No need to chase clients for payments.",
        ...
        "t_post_project_skills_hint"                               => "Enter up to 5 skills (min 1 skill) that best describe your project. Freelancers will use these skills to find projects they are most interested and experienced in",
        ...
        "t_toast_select_at_least_5_skills"                         => "Please select at least 1 skill",
        ...
        "t_article_image_alt"                                       => "Alt text for cover image",
        "t_slider_section"                                       => "Sliders",
        "t_sliders"                                             => "Sliders",
        "t_select_role"                                         => "Select user role",
        "t_freelancer"                                        => "As Freelancer",
        "t_client"                                         => "As Client",
        "t_expertise"                              => "Expertise in",
        "t_speaking_languages"                     => "Language Speaks",
        "t_gdrive"                                  => "Google Drive",
        "t_enter_gdrive_profile"                     => "Google Drive Profile",
        "t_experties_subcategory"                     => "Expertiese Subcategory",
        "t_experties_category"                     => "Choose Expertiese",
        "t_select_experties_category"                     => "Choose Expertiese Category",
        "t_select_exp_subcategory"                     => "Expertise Subcategory",
        "t_explore_sellers"                     => "Explore Freelancers",
         "t_category"                     => "Explore Category",
        ...
        "t_live_chat_settings_sidebar"      => "Chat Setting",
        ...
        "t_payouts_history"            => "Payout History",
         "t_slide1_headline"            => "Join The Freelancing Revolution",
         "t_slide1_button_1"            => "Join us Now",
         "t_slide1_button_2"            => "Apply to live Projects",
         "t_slide2_headline"            => "Free up your time and focus on what matters",
         "t_slide2_button_1"            => "Find Freelancers",
         "t_slide2_button_2"            => "Post Your Project Today",
         ...
         "t_orders_under_progress"    => "Orders Under Progress",
         "t_canceled_orders"          => "Canceled Orders",
         "t_new_messages"             => "New Messages",
         "t_account_landing"          => "Welcome Freelancer",
         "t_pending_checkout_payments" => "Pending Checkout Payments",
         "t_ur_projects_page_is_empty"  => "There is no project awarded",
          "t_ur_projects_page_is_empty_subtitle"  => "Participate in bidding to get new projects",
          "my_portfolio"                => "My Portfolio",
          "t_shared_photos"             => "Shared Photos",
          "t_nothing_shared_yet"         => "Nothing shared yet",
           "t_number_order_in_queue"         => "Orders in que",
           "t_per_word"             => "Per Word",
           "t_per_minute"           => "Per Minute",
           "t_per_unit"             => "Per Unit",  
           "t_per_project"          => "Per Project",
           "t_per_question"         => "Per Question",
           "t_per_art_image"        => "Per Art/Image",
           "t_per_second"           => "Per Second",
           "t_per_book"             => "Per Book",
           "t_per_cover"            => "Per Cover",
           "t_per_course"           => "Per Course",
           "t_per_video"            => "Per Video",
           "t_per_animation"        => "Per Animation",
           "t_per_chapter"          => "Per Chapter",
           "t_per_page"             => "Per Page",
           "t_per_others"           => "Others",
           "t_per_minute_price"     => "Per Minute Price",
           "t_per_second_price"     => "Per Second Price",
           "t_per_word_price"       => "Per Word Price",
           "t_per_unit_price"       => "Per Unit Price",
           "t_per_chapter_price"    => "Per Chapter Price",
           "t_per_book_price"       => "Per Book Price",
           "t_per_cover_price"      => "Per Cover Price",
           "t_per_question_price"       => "Per Question Price",
           "t_per_course_price"         => "Per course Price",
           "t_per_art_image_price"      => "Per Art/image Price",
           "t_per_video_price"          => "Per Video Price",
           "t_per_animation_price"      => "Per Animation Price",
           "t_per_page_price"           => "Per Page Price",
           "t_per_others_price"         => "Per Others Price",
           "t_bid"                      => "Bid",
           "t_click"                    => "Click",
           "t_impression"               => "Impression",
           "t_submitted_date"           => "Submitted Date",
           "t_no_projects_yet"          => "No projects yet",
           "t_contact_skilled_freelancers_within_mintes"           => "Contact skilled freelancers within minutes",
           ...
           "t_addon_total"              => "Addon services total",
           "t_update_and_next"          => "Update & Next",
           "t_choose_skill"             => "Choose your skill",
           "t_back_to_proposals"       => "Back to Proposals",
           "t_promote_ur_proposal"     => "Promote Your Proposals",
           "t_home_about_us_short_descreption" => "The platform focuses on 16 skill categories for the Education and Content industry  that connects clients with talented freelancers from around the world. It will provide businesses and individuals with access to a diverse pool of skilled professionals, enabling them to complete their projects quickly, efficiently, and cost-effectively. We offer end-to-end managed services for mid-to-long term projects.",
           "t_login_to_bid_on_this_project"    => "Login to bid this project",
           "t_email_verified"           => "Email Verified",
           "t_seller_skills"            => "Select Skills",
           "t_edit_my_proposal"         => "Edit My Proposal",
           "t_my_proposal"              => "My Proposal",
           "t_more"                     => "View more",
           "t_less"                     => "View less",
           "t_country_required"         => "Country Required",
           "t_add_new_work"             => "Add New Work",
           "t_back_to_my_works"         => "Back to my works",
           "t_previous_project_title"   => "Previous Project Title",
           "t_previous_project_description" => "Previous Project Description",
           "t_referrer"                 => "Referrer",
           "t_razorpay_fee"             => "Platform Fee + Gateway Conv. Fee",
           "t_notification_u_have_received_a_new_bid" => "You have received a new bid",
           "t_subject_everyone_u_received_new_bid" => "You received new bid",
           ...
           "t_insufficient_funds"       => "Insufficient fund",
           "t_extra_funds_needed"       => "You do not have sufficient funds in your account. Extra Amount needed to Award this project to the seller <br/><p><span class='d-inline'>:currency</span> <span id='amountDisplay' class='d-inline p-1 rounded border border-gray-300'>:amount</span> <button id='copyButton' class='d-inlline btn-sm rounded border border-gray-300 footer-second text-xs font-semibold text-white' onclick='copyToClipboard()'>Copy</button> <a href='/account/deposit?add_fund=:amount' class='btn-sm rounded bg-primary-500 border border-gray-300  text-xs font-semibold text-white'>Deposit</a></p>",
           "t_congratulations_employer_awarded_u_their_project_title" => "Congratulations Buyer has awarded you their project",
           ...
           "t_milestone_freelancer_fee_name" => 'Platform Fee',
           "t_confirm"                  => "Confirm",
           "t_employer_milestone_payments_subtitle" => "Buyer milestone payments",
           "t_awarded_bid"      => "Awarded Bid",
           "t_paid_to_freelancer" => "Paid to Freelancer",
           "t_subject_employer_freelancer_accepted_ur_project" => "Freelancer has accepted your project",
           "t_notification_username_has_accepted_ur_project"    => "Freelancer :username has accepted your project",
           "t_subject_employer_freelancer_requested_a_milestone" => "Freelancer has requested a milestone",
           "t_notification_username_has_requested_a_milestone"  => "Freelancer :username has requested a milestone",
           "t_deposit_funds"        => "Deposit funds",
           "t_u_will_be_depositing_this_amount_employer_milestone" => "You will be depositing :amount to milestone",
           ...
           "t_pls_ensure_that_u_are_satisfied_with_work_freelancer" => "Please ensure that you are satisfied with work of Freelancer",
           "t_release"      => "Release fund",
           "t_latest_awarded_projects" => "Latest awarded projects",
           "t_username_has_deposited_amount_in_project" => ":username has deposited amount in project",
           "t_username_has_released_amount_in_project" => ":username has released amount in project",
           ...
           "t_insert_emoji"                 => "Insert emojis",
           "t_emojis_recently_used"         => "Recently used",
           "t_emojis_smileys"               => "Smileys",
           "t_emojis_animals_nature"        => "Animals and Nature",
           "t_emojis_food_drink"            => "Food and Drink",
           "t_emojis_activity"              => "Activity",
           "t_emojis_travel"                => "Travel",
           "t_emojis_objects"               => "Objects",
           "t_emojis_symbols"               => "Sybmols",
           "t_emojis_flags"                 => "Flags",
           "t_insufficient_funds_in_your_account"   => "Insufficient funds in your account",
           "t_the_amount_to_be_paid_to_freelancer"  => "The amount to be paid",
           "t_search_users"                 => "Search Users",
           "t_revision_request"             => "Revision Request",
           "t_my_revision_request"          => "Project Revision Request",
           "t_project_revision"             => "Project Revision",
           "t_define_budget"                => "Define Budget",
           "t_define_min_max_budget"        => "Enter Min and Max amount",
           "t_enter_min_amount"             => "Min Amount",
           "t_enter_max_amount"             => "Max Amount",
           "t_final_min_price"              => "Minimum Price",
           "t_final_max_price"              => "Maximum Price",
           "t_enter_the_post_number"        => "Approx volume of work",
           "t_subject_employer_project_approved" => "Your project has been approved",
           "t_notification_ur_project_has_been_approved" => "Your project has been approved. Keep posting your requirement.",
           "t_light"                        => "Light Mode",
           "t_currency_conversion_info"     => "Please note that the price may fluctuate during the transaction.",
