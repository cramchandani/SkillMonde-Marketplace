			...
			<div class="h-80 w-full absolute bottom-0 xl:inset-0 xl:h-full">
				<div class="h-full w-full xl:grid xl:grid-cols-2">
					<div class="h-full xl:relative xl:col-start-2">
						<img class="h-full w-full object-cover opacity-75 xl:absolute xl:inset-0 ltr:rounded-r-lg rtl:rounded-l-lg lazy" src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(url('public/img/start_selling/selling.png')); ?>" alt="<?php echo e(__('messages.t_u_bring_the_skill_make_earn_easy')); ?>">
					...
					<div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
						...
						<p>
							<span class="block text-xl font-bold text-gray-600 uppercase">
								<?php echo money(50, settings('currency')->code, true); ?> - <?php echo money(100000, settings('currency')->code, true); ?>
							</span>
							<span class="mt-1 block text-base text-black"><?php echo e(__('messages.t_price_range')); ?></span>
						</p>
...
</div><?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/become/seller.blade.php ENDPATH**/ ?>