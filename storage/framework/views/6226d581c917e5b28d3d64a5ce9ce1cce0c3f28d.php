				...
				<form x-data="window.UcZWcDFfVKBjfgP" x-on:submit.prevent="register" class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                    ...
                    <div class="col-span-12">
                        <div class="relative w-full shadow-sm rounded-md">
                            <select x-model="form.account_type" name="account_type" x-on:change="form.account_type = $event.target.value" class="<?php echo e($errors->first('account_type') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                                <option value=""><?php echo e(__('messages.t_select_role')); ?></option>
                                <option value="seller"><?php echo e(__('messages.t_freelancer')); ?></option>
                                <option value="buyer"><?php echo e(__('messages.t_client')); ?></option>
                            </select>
                ...
                <?php /* ?>
					...
					<div class="col-span-12">
						<div class="relative w-full shadow-sm rounded-md">
							...
							<input type="password" x-model="form.password" pattern=".{6,60}" class="<?php echo e($errors->first('password') ? 'focus:ring-red-600 focus:border-red-600 border-red-500' : 'focus:ring-primary-600 focus:border-primary-600 border-gray-300'); ?> border text-gray-900 text-sm rounded-md font-medium block w-full ltr:pr-12 rtl:pl-12 p-4 placeholder:font-normal  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="<?php echo e(__('messages.t_enter_password')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-12">
                        ...
                        <label class="flex items-center space-x-2">
                            ...
                            <span class="text-gray-700" style="color: #4C3494;"><a href="<?php echo e(url('page', settings('footer')->terms->slug)); ?>" target="_blank"><?php echo app('translator')->get('messages.t_by_signup_u_agree_to_terms_privacy'); ?></a></span>
                        </label>
                    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/auth/register.blade.php ENDPATH**/ ?>