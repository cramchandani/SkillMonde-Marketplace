                            ...
                            <?php if($page->column == 1): ?>
                                <li>
                                    <?php if($page->is_link && $page->link): ?>
                                        <a href="<?php echo e($page->link); ?>" target="_blank" class="block font-normal text-white hover:text-white-400 hover:underline dark:text-white-100 dark:hover:text-gray-50 text-sm mb-2">
                                            <?php echo e($page->title); ?>

                                        </a>
                                    <?php else: ?>
                                        <a href="<?php echo e(url('page', $page->slug)); ?>" class="block font-normal text-white hover:text-white-400 hover:underline dark:text-white-100 dark:hover:text-white-50 text-sm mb-2">
                                            <?php echo e($page->title); ?>
                    ...
                    <ul>
                        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page->column == 2): ?>
                                <li>
                                    <?php if($page->is_link && $page->link): ?>
                                        <a href="<?php echo e($page->link); ?>" target="_blank" class="block font-normal text-white hover:text-white-400 hover:underline dark:text-white-100 dark:hover:text-white-50 text-sm mb-2">
                                            <?php echo e($page->title); ?>

                                        </a>
                                    <?php else: ?>
                                        <a href="<?php echo e(url('page', $page->slug)); ?>" class="block font-normal text-white hover:text-gray-400 hover:underline dark:text-white-100 dark:hover:text-white-50 text-sm mb-2">
                                            <?php echo e($page->title); ?>
                    ...
                    <ul>
                        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page->column == 3): ?>
                                <li>
                                    <?php if($page->is_link && $page->link): ?>
                                        <a href="<?php echo e($page->link); ?>" target="_blank" class="block font-normal text-white hover:text-white-400 hover:underline dark:text-gray-100 dark:hover:text-white-50 text-sm mb-2">
                                            <?php echo e($page->title); ?>
                    ...
                    <ul>
                        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page->column == 4): ?>
                                <li>
                                    <?php if($page->is_link && $page->link): ?>
                                        <a href="<?php echo e($page->link); ?>" target="_blank" class="block font-normal text-white hover:text-white-400 hover:underline dark:text-gray-100 dark:hover:text-gray-50 text-sm mb-2">
                                            <?php echo e($page->title); ?>

                                        </a>
                                    <?php else: ?>
                                        <a href="<?php echo e(url('page', $page->slug)); ?>" class="block font-normal text-white hover:text-white-400 hover:underline dark:text-gray-100 dark:hover:text-gray-50 text-sm mb-2">
                                            <?php echo e($page->title); ?>
    ...
    <div class="text-center footer-second py-2 text-white">
        <div class="container-fluid mx-auto">    
            ...
            <div class="flex space-x-4 justify-center rtl:space-x-reverse">
                ...
                <a href="<?php echo e(url('help/contact')); ?>" class="text-sm font-semibold uppercase text-white dark:text-white-400 dark:hover:text-white-100 hover:text-white-600"><?php echo e(__('messages.t_contact_us')); ?></a>

                
                <?php if(settings('footer')->privacy): ?>
                    <a href="<?php echo e(url('page', settings('footer')->privacy->slug)); ?>" class="text-sm font-semibold uppercase text-white dark:text-white-400 dark:hover:text-white-100 hover:text-white-600"><?php echo e(__('messages.t_privacy_policy')); ?></a>
                <?php endif; ?>

                
                <?php if(settings('footer')->terms): ?>
                    <a href="<?php echo e(url('page', settings('footer')->terms->slug)); ?>" class="text-sm font-semibold uppercase text-white dark:text-white-400 dark:hover:text-white-100 hover:text-white-600"><?php echo e(__('messages.t_terms_of_service')); ?></a>
                <?php endif; ?>

                
                <?php if(settings('blog')->enable_blog): ?>
                    <a href="<?php echo e(url('blog')); ?>" class="text-sm font-semibold uppercase text-white dark:text-white-400 dark:hover:text-white-100 hover:text-white-600"><?php echo e(__('messages.t_blog')); ?></a>
                <?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/includes/footer.blade.php ENDPATH**/ ?>