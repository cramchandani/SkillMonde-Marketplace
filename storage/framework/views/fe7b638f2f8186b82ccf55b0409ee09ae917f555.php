...
} elseif ($_instance->childHasBeenRendered('aHhWiqk')) {
    $componentId = $_instance->getRenderedChildComponentId('aHhWiqk');
    $componentTag = $_instance->getRenderedChildComponentTagName('aHhWiqk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aHhWiqk');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('aHhWiqk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('zvNcEgb')) {
    $componentId = $_instance->getRenderedChildComponentId('zvNcEgb');
    $componentTag = $_instance->getRenderedChildComponentTagName('zvNcEgb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zvNcEgb');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('zvNcEgb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/skillmonde/public_html/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>