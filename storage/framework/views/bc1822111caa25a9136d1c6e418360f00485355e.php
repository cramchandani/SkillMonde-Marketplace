						...
						<div class="py-3.5 px-4 w-full rounded-t-lg flex items-center sm:justify-between bg-gray-50 dark:bg-zinc-700 h-16 space-y-3 sm:space-y-0">
							...
							<?php if(auth()->guard()->guest()): ?>
							    <a href="https://skillmonde.com/auth/login" class="inline-flex justify-center items-center rounded border font-semibold tracking-wide focus:outline-none px-4 py-2 shadow-sm hover:shadow-none leading-5 text-[13px] border-gray-200 primary-btn text-white hover:text-gray-700 hover:border-gray-200 focus:ring focus:ring-gray-200 focus:ring-opacity-50 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-300 dark:focus:ring-zinc-400 dark:hover:bg-zinc-600 dark:hover:text-zinc-100 dark:focus:border-zinc-500">
										<span><?php echo app('translator')->get('messages.t_login_to_bid_on_this_project'); ?></span>
								</a>
							<?php endif; ?>
                        ...
                        <dl>
                            ...
                            <div class="bg-white dark:bg-zinc-700 px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-zinc-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                                   <span id="inr-min"> <?php echo money($project->budget_min, settings('currency')->code, true); ?><span> – <span id="inr-max"><?php echo money($project->budget_max, settings('currency')->code, true); ?></span>
                                </dd>
                                <dt class="text-sm font-medium text-gray-500 dark:text-zinc-300">
                                    ...
                                    <div id="usd-message" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                         <?php echo e(__('messages.t_currency_conversion_info')); ?>       
                                    </div>
                                </dt>
                                <dd id="approx-usd" class="mt-1 text-sm text-zinc-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                                   $<?php echo e(number_format($minBudgetUSD, 2)); ?> – $<?php echo e(number_format($maxBudgetUSD, 2)); ?>

                                </dd>
                            </div>

							
							<?php if(in_array($project->budget_type, ['fixed', 'per_others'])): ?>
							...
							<?php if(!in_array($project->budget_type, ['fixed', 'per_others'])): ?>
							<div class="bg-white dark:bg-zinc-700 px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500 dark:text-zinc-300"><?php echo app('translator')->get('messages.t_enter_the_post_number'); ?></dt>
								<dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0">
								    <?php switch($project->budget_type):

										
										case ('hourly'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Hours
											</span>
											<?php break; ?>
										...
										<?php case ('per_word'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Words
											</span>
											<?php break; ?>
										...
										<?php case ('per_minute'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Minutes
											</span>
											<?php break; ?>
										...
										<?php case ('per_unit'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Units
											</span>
											<?php break; ?>
											
										
										<?php case ('per_question'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Questions
											</span>
											<?php break; ?>
											
										
										<?php case ('per_art_image'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Arts/Images
											</span>
											<?php break; ?>
										...
										<?php case ('per_second'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Seconds
											</span>
											<?php break; ?>
										...
										<?php case ('per_book'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Book
											</span>
											<?php break; ?>
										...
										<?php case ('per_cover'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Cover
											</span>
											<?php break; ?>
										...
										<?php case ('per_course'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Course
											</span>
											<?php break; ?>
										...
										<?php case ('per_video'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Video
											</span>
											<?php break; ?>
											
										
										<?php case ('per_animation'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Animation
											</span>
											<?php break; ?>
											
										
										<?php case ('per_chapter'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Chapter
											</span>
											<?php break; ?>
										...
										<?php case ('per_page'): ?>
											<span class="bg-purple-100 text-gray-700 mt-1 inline-block sm:mt-0 sm:rounded-3xl py-2 px-5 font-semibold text-xs">
												<?php echo e($project->total_numbers); ?> Page
											</span>
											<?php break; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/project/project.blade.php ENDPATH**/ ?>