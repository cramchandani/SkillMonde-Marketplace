<div class="w-full relative">
    ...
    <?php if(isset($view_data['freelancer']) && $view_data['freelancer'] !== null): ?>
            ...
            <div class="mb-2 font-normal text-sm leading-relaxed text-gray-500 dark:text-gray-300">
                <?php if(auth()->guard()->guest()): ?>
                    <div class="break-all">
                        ...
                        <div class="mb-2 font-normal text-sm leading-relaxed text-gray-500 dark:text-gray-300">
                            <?php echo e(Str::limit(htmlspecialchars_decode($view_data['bid']['message']), 50, '...')); ?>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->uid === $view_data['project']['employer_id']): ?>
                        ...
                        <?php if(strlen($view_data['bid']['message']) > 50): ?>
                            <div class="break-all">
        
                                
                                <span id="bid-card-message-short-<?php echo e($view_data['bid']['id']); ?>">
                                    <?php echo e(add_3_dots(htmlspecialchars_decode($view_data['bid']['message']), 50, null)); ?>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->uid === $view_data['project']['employer_id']): ?>
                        ...
                        <?php if($this->view_data['freelancer']['chat']): ?>
                            <a href="<?php echo e(url('messages/new', $view_data['freelancer']['username'])); ?>" class="inline-flex items-center rounded border border-gray-300 bg-primary-500 px-2.5 py-1.5 text-xs font-semibold text-gray-100 hover:text-gray-100 shadow-sm hover:bg-primary-600 focus:outline-none focus:ring-1 focus:ring-opacity-50 focus:ring-zinc-300 focus:ring-offset-2 focus:ring-offset-zinc-100 space-x-1 rtl:space-x-reverse dark:shadow-none dark:bg-zinc-700 dark:border-zinc-800 dark:hover:bg-zinc-700/40 dark:text-zinc-300 dark:hover:text-gray-100 dark:ring-offset-zinc-500">
...
</div><?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/cards/bid.blade.php ENDPATH**/ ?>