<div class="about-us" style="max-width:97%; margin:auto;">
            ...
            <div class="cover vh-100" style="position: relative; background-image: url('<?php echo e(asset('public/img/managed/iStock-1357637056_compressed.jpg')); ?>'); background-size: cover;">
                <div style="position: absolute; top: 0; left: 0; bottom: 0; right: 0; background-color: rgba(158, 0, 255, 0.08);"></div>
                <div class="bg-dark h-100 w-100 bg-opacity-25 d-flex flex-column align-items-center justify-content-center text-white">
                    <h1 class="fw-bold">Edtech</h1>
                    <h4 class="mb-0 text-center text-lg font-semibold p-4" style="background: rgba(0, 0, 0, 0.38);">Power Up Your EdTech: <br>Tailored Services to Take Your Company to the Next Level!</h4>
                </div>
            </div>
            ...
            <div class="hiw my-5 px-md-5 px-sm-4 px-3 container-fluid">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-12 col-12 order-lg-2 order-0 d-flex">
                        <div>
                            <h3 class="text-center font-bold py-2" style="color: #8ccf27;">Content Solution Offering for Edtech</h3>
            ...
            <div class="omso mb-5">
                <h3 class="text-center font-bold mb-4" style="color: #8ccf27;">Our Managed Service Offerings</h3>
            ...
            <div class="why-us mx-md-5 mx-sm-4 mx-3 mb-5 row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">   
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <h6 class="mb-0 fw-normal">Customized learning experiences </h6>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <i
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/custompage/edtech.blade.php ENDPATH**/ ?>