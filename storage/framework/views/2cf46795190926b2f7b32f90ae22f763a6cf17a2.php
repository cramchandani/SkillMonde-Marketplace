   ...
   <div x-data="window.TTRjRvxLbHzaKxW">
        ...
        <?php if(auth()->guard('admin')->check()): ?>
            <div class="bg-gray-900">
                <div class="max-w-screen-2xl mx-auto h-10 px-4 flex items-center justify-between sm:px-6 lg:px-8">
        ...
        <nav class="relative container max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 justify-between items-center h-20 flex" style="max-width: 94%;">
            ...
            <div class="inline-flex items-center min-w-fit">
                ...
                <?php if(Cookie::get('dark_mode') === 'enabled' && settings('general')->logo_dark): ?>
                    <a href="<?php echo e(url('/')); ?>" class="block ltr:sm:mr-6 rtl:sm:ml-6">
                        <img width="200" height="<?php echo e(settings('appearance')->sizes['header_desktop_logo_height']); ?>" src="<?php echo e(src(settings('general')->logo_dark)); ?>" alt="<?php echo e(settings('general')->title); ?>" style="height: <?php echo e(settings('appearance')->sizes['header_desktop_logo_height']); ?>px;width:auto">
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(url('/')); ?>" class="block ltr:sm:mr-6 rtl:sm:ml-6">
                        <img width="200" height="<?php echo e(settings('appearance')->sizes['header_desktop_logo_height']); ?>" src="<?php echo e(src(settings('general')->logo)); ?>" alt="<?php echo e(settings('general')->title); ?>" style="height: <?php echo e(settings('appearance')->sizes['header_desktop_logo_height']); ?>px;width:auto">
                    </a>
                <?php endif; ?>
            ...
            <div class="min-w-fit ltr:sm:ml-10 rtl:sm:mr-10 flex items-center font-medium text-sm transition-all duration-200">
                ...
                <a href="/#managed-services" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 px-4 hidden md:block dark:text-gray-100 dark:hover:text-white" onclick="smoothScroll('#managed-services'); return false;">Managed Services</a>
                    ...
                    <div 
                        ...
                        <div class="bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 rounded divide-y divide-gray-100 dark:divide-zinc-400">
                            <div class="p-2 space-y-1">
                                ...
                                <a href="<?php echo e(url('sellers')); ?>" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                    <span><?php echo app('translator')->get('messages.t_explore_sellers'); ?></span>
                                </a>
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(url('post-project')); ?>" class="text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 px-4 hidden md:block dark:text-gray-100 dark:hover:text-white">
                    ...
                    <div 
                        ...
                        <div class="bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 rounded divide-y divide-gray-100 dark:divide-zinc-400">
                            <div class="p-2 space-y-1">
                                ...
                                <a href="<?php echo e(url('auth/login')); ?>" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                    <span><?php echo app('translator')->get('messages.t_sign_in'); ?></span>
                                </a>
                                
                                 
                                <a href="<?php echo e(url('auth/register')); ?>" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
...
} elseif ($_instance->childHasBeenRendered('l2308279060-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2308279060-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2308279060-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2308279060-0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('l2308279060-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l2308279060-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2308279060-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2308279060-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2308279060-1');
} else {
    $response = \Livewire\Livewire::mount('main.partials.cart');
    $html = $response->html();
    $_instance->logRenderedChild('l2308279060-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="hidden md:inline-block relative ltr:ml-4 rtl:mr-4" x-data="{ open: false }">
                        ...
                        <?php if(auth()->user()->avatar): ?>
                          ...
                          <div class="lazy inline-block w-8 h-8 rounded-full cursor-pointer border border-gray-400 object-cover text-center pt-1" x-on:click="open = !open"><i class="fas fa-bars"></i></div>
                        <?php else: ?>
                        ...
                        <div 
                            ...
                            class="absolute top-full ltr:right-0 rtl:left-0 w-60 mt-3 bg-white dark:bg-zinc-800 rounded-lg shadow-md ring-1 ring-gray-900 ring-opacity-5 font-normal text-sm text-gray-900 divide-y divide-gray-100 dark:divide-zinc-700 z-40">
                                ...
                                <div class="py-1.5 px-3.5">
                                    ...
                                    <a href="<?php echo e(url('seller/projects/bids')); ?>" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                        ...
                                        <span class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500"><?php echo e(__('messages.t_awarded_projects')); ?></span>
                                    </a>

                                    
                                    <?php /*?>
                                    <a href="{{ url('/seller/projects/bids') }}" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                ...
                                <div class="py-1.5 px-3.5">
                                    ...
                                    <a href="https://affiliate.skillmonde.com/usercontrol/dashboard" target="_blank" class="group flex items-center py-1.5 group-hover:text-primary-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="flex-none ltr:mr-3 rtl:ml-3 text-gray-400 group-hover:text-primary-600 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <path stroke-linecap="round" stroke-linejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>
                                        <span class="font-semibold text-xs text-gray-700 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-500">Affiliate</span>
                                    </a>
...
<div class="relative nav-second container mx-auto px-4 sm:px-6 lg:px-8 hidden md:block" style="max-width: 94%;">
  ...
  <div class="flex items-center space-x-2 overflow-x-auto">
    ...
    <div class="absolute inset-y-0 left-0 flex items-center">
      <a href="javascript:void(0)" class="text-white link" aria-label="Scroll left" onclick="scrollCategories('left')">
        <svg class="w-6 h-6 text-white dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
            ...
            <ul id="categories" class="relative flex items-center justify-between overflow-y-auto transition-colors duration-300 space-x-5 rtl:space-x-reverse scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-zinc-600 scrollbar-track-gray-50 dark:scrollbar-track-zinc-400">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="inline-block flex-shrink-0 border-b-2 border-transparent hover:border-primary-600 focus:outline-none focus:ring-0 relative">
                        ...
                        <?php if(count($category->subcategories)): ?>
                            <button data-popover-target="popover-subcategories-<?php echo e($category->uid); ?>" data-popover-trigger="hover" class="block text-[13px] font-semibold text-gray-700 dark:text-gray-300 dark:group-hover:text-white group-hover:text-primary-600 py-2 focus:outline-none focus:ring-0 text-white">
    ...
    <div class="absolute inset-y-0 right-0 flex items-center">
      <a href="javascript:void(0)" class="text-white link" aria-label="Scroll right" onclick="scrollCategories('right')">
        <svg class="w-6 h-6 text-white dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div data-popover id="popover-subcategories-<?php echo e($category->uid); ?>" data-popover-placement="bottom" role="tooltip" class="absolute z-10 invisible inline-block w-64 text-sm font-light text-gray-500 transition-opacity duration-300 bg-white rounded-md shadow-xl opacity-0 dark:text-zinc-400 dark:bg-zinc-800 max-h-80 overflow-y-auto">
              <ul class=" !overflow-y-auto scrollbar-thin scrollbar-thumb-primary-600 scrollbar-track-white dark:scrollbar-track-zinc-800">
                <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="first:rounded-t-md">
                        <a href="<?php echo e(url('categories/' . $category->slug . '/' . $sub->slug)); ?>" class="flex items-center py-1 px-3 hover:bg-gray-50 dark:hover:bg-zinc-700" style="border-radius: inherit">
            ...
            <div class="bg-gray-50 dark:bg-zinc-700 rounded-b-md text-center browse secondary-btn">
                <a href="<?php echo e(url('categories', $category->slug)); ?>" class="block px-1 py-2 text-white dark:text-zinc-300 hover:text-primary-600 hover:underline text-xs tracking-wide font-semibold">
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div x-show="mobile_menu" style="display: none" class="fixed inset-0 flex z-40 lg:hidden" x-ref="mobile_menu">
            ...
            <div 
                ...
                class="relative max-w-[275px] w-full mobile-menu-background dark:bg-zinc-700 shadow-xl flex flex-col overflow-y-auto">
                ...
                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['w-full overflow-auto h-full', 'pt-5' => auth()->check()]) ?>">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->user()->account_type === 'seller'): ?>
                                <a href="<?php echo e(url('seller/orders')); ?>" class="text-white hover:text-primary-600 dark:text-gray-100 dark:hover:text-white transition-colors duration-300 py-2 mx-4 relative md:hidden">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <button x-on:click="notifications_menu = true" type="button" class="text-white hover:text-primary-600 transition-colors duration-300 py-2 relative mx-4 dark:text-gray-100 dark:hover:text-white md:hidden">
                                <svg class="text-white hover:text-gray-700 h-6 w-6 dark:text-gray-100 dark:hover:text-white" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M19 13.586V10c0-3.217-2.185-5.927-5.145-6.742C13.562 2.52 12.846 2 12 2s-1.562.52-1.855 1.258C7.185 4.074 5 6.783 5 10v3.586l-1.707 1.707A.996.996 0 0 0 3 16v2a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-2a.996.996 0 0 0-.293-.707L19 13.586zM19 17H5v-.586l1.707-1.707A.996.996 0 0 0 7 14v-4c0-2.757 2.243-5 5-5s5 2.243 5 5v4c0 .266.105.52.293.707L19 16.414V17zm-7 5a2.98 2.98 0 0 0 2.818-2H9.182A2.98 2.98 0 0 0 12 22z"></path></svg>
                                <?php if($notifications && count($notifications)): ?>
                                    <span class="flex absolute h-2 w-2 top-0 ltr:right-0 rtl:left-0 mt-0 ltr:-mr-1 rtl:-ml-1">
                                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary-400 opacity-75"></span>
...
<?php endif; ?>
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(url('auth/login')); ?>" class="py-2 px-5 block text-white dark:text-gray-200 font-semibold text-sm">
                    ...
                    <?php if(auth()->guest() || ( auth()->check() && auth()->user()->account_type !== 'seller' )): ?>
                        <a href="<?php echo e(url('start_selling')); ?>" class="py-2 px-5 block text-white dark:text-gray-200 font-semibold text-sm">
                            <?php echo app('translator')->get('messages.t_become_a_seller'); ?>
                        </a>
                    <?php endif; ?>

                    
                    <a href="<?php echo e(url('search')); ?>" class="py-2 px-5 block text-white dark:text-gray-200 font-semibold text-sm">
                        <?php echo app('translator')->get('messages.t_explore_gigs'); ?>
                    </a>
                    
                    <a href="/#managed-services" class="py-2 px-5 block text-white dark:text-gray-200 font-semibold text-sm" onclick="smoothScroll('#managed-services'); return false;">Managed Services</a>

                    
                    <div x-data="{ open: false }" class="space-y-1">

                        
                        <a href="javascript:void(0)" class="py-2 px-5 text-white dark:text-gray-200 font-semibold text-sm flex items-center space-x-3 rtl:space-x-reverse relative z-1" x-on:click="open = !open">
                            <span class="grow">
                        ...
                        <div 
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <details class="group ltr:ml-4 rtl:mr-4" wire:key="header-categories-<?php echo e($category->uid); ?>">
                                    ...
                                    <summary class="flex items-center text-white dark:text-gray-300 py-2 px-5">
                    ...
                    <div x-data="{ open: false }" class="space-y-1">
                        ...
                        <a href="javascript:void(0)" class="py-2 px-5 text-white dark:text-gray-200 font-semibold text-sm flex items-center space-x-3 rtl:space-x-reverse relative z-1" x-on:click="open = !open">
                            <span class="grow">
                                <?php echo app('translator')->get('messages.t_explore'); ?>
                            </span>
                            <span x-bind:class="{ 'rotate-90': !open, 'rotate-0': open }" class="transform transition ease-out duration-150 opacity-75 rotate-0">
                                <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" class="hi-solid hi-chevron-down inline-block w-4 h-4"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                            </span>
                        ...
                        <div 
                            ...
                            class="relative z-0">
                                ...
                                <nav class="mt-1.5 ltr:ml-8 rtl:mr-8 flex flex-col">
                                    ...
                                    <a href="<?php echo e(url('search')); ?>" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-white hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                        <span><?php echo app('translator')->get('messages.t_explore_gigs'); ?></span>
                                    </a>
    
                                    
                                    <?php if(settings('projects')->is_enabled): ?>
                                        <a href="<?php echo e(url('explore/projects')); ?>" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-white hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                            <span><?php echo app('translator')->get('messages.t_explore_projects'); ?></span>
                                        </a>
                                    <?php endif; ?>
                                    
                                     
                                    <a href="<?php echo e(url('sellers')); ?>" role="menuitem" class="w-full flex items-center rounded py-2 px-3 text-sm font-medium text-white hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-400 dark:hover:bg-zinc-500 dark:hover:text-zinc-200">
                                        <span><?php echo app('translator')->get('messages.t_explore_sellers'); ?></span>
                                    </a>
                                </nav>
                    </div>
                    ...
                    <a href="<?php echo e(url('/')); ?>" class="py-2 px-5 flex items-center text-white dark:text-gray-200 font-semibold text-sm">
                    ...
                    <a href="<?php echo e(url('help/contact')); ?>" class="py-2 px-5 flex items-center text-white dark:text-gray-200 font-semibold text-sm">
...
function scrollCategories(direction) {
  ...
  const scrollWidth = categoriesElement.scrollWidth;
  const containerWidth = categoriesElement.clientWidth;
  const scrollLeft = categoriesElement.scrollLeft;

  if (direction === "left") {
    categoriesElement.scrollLeft -= Math.min(scrollLeft, containerWidth);
  } else if (direction === "right") {
    categoriesElement.scrollLeft += Math.min(scrollWidth - scrollLeft - containerWidth, containerWidth);
  }
}
</script>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/includes/header.blade.php ENDPATH**/ ?>