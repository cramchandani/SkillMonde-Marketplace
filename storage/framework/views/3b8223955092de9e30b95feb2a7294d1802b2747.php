				...
				class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white dark:bg-zinc-800">
					...
					<div class="mt-8 flex-grow flex flex-col">
						<nav class="flex-1 ltr:pl-2 rtl:pr-5 pb-4 space-y-1.5">
							...
							<a href="https://affiliate.skillmonde.com/usercontrol/dashboard" target="_blank" class="group flex items-center ltr:pl-3 ltr:pr-2 rtl:pr-3 rtl:pl-2 py-2 text-sm font-semibold tracking-wide ltr:rounded-l-full rtl:rounded-r-full <?php echo e(\Illuminate\Support\Str::of(request()->path())->startsWith('seller/withdrawals') ? 'bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-700 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100'); ?>">
				...
				<div class="flex flex-col flex-grow ltr:border-r rtl:border-l border-[#e9eef5] dark:border-zinc-700 pt-5 bg-white dark:bg-zinc-800 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-zinc-900 dark:scrollbar-track-zinc-600">
					...
					<div class="mt-8 flex-grow flex flex-col">
						<nav class="flex-1 ltr:pl-2 rtl:pr-5 pb-4 space-y-1.5">
							...
							<a href="https://affiliate.skillmonde.com/usercontrol/dashboard" target="blank" class="group flex items-center ltr:pl-3 ltr:pr-2 rtl:pr-3 rtl:pl-2 py-2 text-sm font-semibold tracking-wide ltr:rounded-l-full rtl:rounded-r-full <?php echo e(\Illuminate\Support\Str::of(request()->path())->startsWith('seller/withdrawals') ? 'bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-700 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-zinc-700 dark:text-zinc-200 dark:hover:text-zinc-100'); ?>">

								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="text-slate-500 dark:text-zinc-300 flex-shrink-0 h-6 w-6 ltr:mr-3.5 rtl:ml-3.5 -mt-[3px] group-hover:text-slate-700 dark:group-hover:text-zinc-200" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
                                        <rect fill="currentColor" opacity="0.3" x="2" y="4" width="20" height="5" rx="1" />
                                        <path d="M5,7 L8,7 L8,21 L7,21 C5.8954305,21 5,20.1045695 5,19 L5,7 Z M19,7 L19,19 C19,20.1045695 18.1045695,21 17,21 L11,21 L11,7 L19,7 Z" fill="currentColor" />
                                        <!-- Custom affiliate icon shape -->
                                        <!-- You can customize this part to create a unique icon for your affiliate system -->
...
} elseif ($_instance->childHasBeenRendered('7nl4yV0')) {
    $componentId = $_instance->getRenderedChildComponentId('7nl4yV0');
    $componentTag = $_instance->getRenderedChildComponentTagName('7nl4yV0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7nl4yV0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('7nl4yV0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://skillmonde.com/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
  ...
  <?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>