            ...
            <div class="space-x-3 rtl:space-x-reverse">
                ...
                <div class="inline-flex justify-center items-center space-x-2 rtl:space-x-reverse" >
                    <button 
                        ...
                        <span><?php echo e(__('Export Users as CSV')); ?></span>
                    </button>
                </div>
...
<div class="px-4 md:px-3 py-4 md:py-5 bg-white border !border-b-0 dark:bg-gray-700 rounded-tl-lg rounded-tr-lg">
    <div class="sm:flex items-center justify-between">
        <p class="text-sm font-bold leading-wide text-gray-800">
            <?php echo e(__('messages.t_search_users')); ?>
        ...
        <table class="w-full whitespace-nowrap old-tables">
            <thead class="bg-gray-200">
                <tr tabindex="0" class="focus:outline-none h-16 w-full text-sm leading-none text-gray-800 dark:text-white ">
                    ...
                    <th class="font-bold text-[10px] text-slate-500 dark:text-gray-300 uppercase tracking-wider text-center"><?php echo e(__('messages.t_referrer')); ?></th>
            ...
            <tbody class="w-full">
                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="focus:outline-none text-sm leading-none text-gray-800 bg-white dark:bg-zinc-600 hover:bg-gray-100 dark:hover:bg-zinc-700 border-b border-t border-gray-100 dark:border-zinc-700/40" wire:key="users-<?php echo e($user->id); ?>">
                        ...
                        <td class="text-center">
                            <span class="text-xs font-medium text-gray-500"><?php echo e($user->referrer); ?></span>
                        </td>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/skillmonde/public_html/resources/views/livewire/admin/users/users.blade.php ENDPATH**/ ?>