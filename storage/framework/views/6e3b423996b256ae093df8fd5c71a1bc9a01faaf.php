<div class="about-us" style="max-width:97%; margin:auto;">
            ...
            <div class="cover vh-100" style="position: relative; background-image: url('<?php echo e(asset('public/img/managed/iStock-1162324751_compressed.jpg')); ?>'); background-size: cover;">
                ...
                <div class="bg-dark h-100 w-100 bg-opacity-25 d-flex flex-column align-items-center justify-content-center text-white">
                    <h1 class="fw-bold">NGO</h1>
                    <h4 class="mb-0 text-center text-lg font-medium p-4" style="background: rgba(0, 0, 0, 0.38);">We are passionate about supporting your journey <br>to make a positive impact on society through our tailored and engaging content solutions </h4>
                </div>
            </div>
            ...
            <div class="hiw my-5 px-md-5 px-sm-4 px-3 container-fluid">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-12 col-12 order-lg-2 order-0 d-flex">
                        <div>
                            <h3 class="text-center py-2">Content Solution Offerings for NGO </h3>
                            <p class="mb-0 text-secondary text-base text-justify pt-4">The world in which non-governmental organisations (NGOs) operate is complex. Due to the increased demand for their services, it is becoming increasingly important for them to ensure that they are reaching as many people as possible. This requires the utilization of compelling and effective content on websites, social media platforms, and printed materials. Content services are essential for NGOs to engage with their target audiences, build relationships, and spread awareness of issues. Also, in order to conduct effective training and educational programmes, NGOs require interesting content that will enable them to accomplish their goals. A wide range of content services are offered by SkillMonde to assist NGOs in having the impact they desire by managing the entire project within stipulated timelines and budget.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/custompage/ngo.blade.php ENDPATH**/ ?>