        ...
        <div class="w-full mb-0 md:mb-12">
            ...
            <div class="md:flex items-center justify-between mb-0 md:mb-6">
                ...
                <div class="hidden items-center md:!grid">
                    ...
                    <span id="gig-amount" class="text-black dark:text-white text-2xl tracking-wide font-black"><?php echo money($gig->price, settings('currency')->code, true); ?></span>
                </div>
        ...
        <div class="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16 main">
            ...
            <div class="max-w-2xl mx-auto mt-6 md:mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2 buttons d-flex justify-content-between my-2">
                    ...
                    <a href="<?php echo e(url('messages/new', $gig->owner->username)); ?>" target="_blank" class="w-full bg-primary-100 border border-transparent rounded-md py-4 px-8 flex items-center justify-center text-[13px] font-medium text-primary-600 hover:bg-primary-200 focus:outline-none btn rounded-pill w-100 seller"><?php echo e(__('messages.t_contact_seller')); ?></a>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/service/service.blade.php ENDPATH**/ ?>