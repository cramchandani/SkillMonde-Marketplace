<div class="about-us" style="max-width:97%; margin:auto;">
            ...
            <div class="cover vh-100" style="position: relative; background-image: url('<?php echo e(asset('public/img/managed/iStock-1140691163_compressed.jpg')); ?>'); background-size: cover;">
                ...
                <div class="bg-dark h-100 w-100 bg-opacity-25 d-flex flex-column align-items-center justify-content-center text-white">
                    <h1 class="fw-bold">Corporate</h1>
                    <h4 class="mb-0 text-center text-lg font-medium p-4" style="background: rgba(0, 0, 0, 0.38);">Effective e-learning courses tailored to the needs of your organization</h4>
                </div>
            </div>
            ...
            <div class="hiw my-5 px-md-5 px-sm-4 px-3 container-fluid">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-12 col-12 order-lg-2 order-0 d-flex">
                        <div>
                            <h3 class="text-center py-2">Content Solution Offering for Corporates</h3>
                            <p class="mb-0 text-secondary text-base text-justify pt-4">To remain competitive, corporate organisations are increasingly relying on content and eLearning services. These services provide a wide range of advantages that can help organisations reach their full potential, from developing engaging digital experiences for both consumers and staff to offering thorough training courses that guarantee everyone stays current with market trends.
                            </p>
                            <p class="mb-0 text-secondary text-base text-justify pt-4">Corporate organisations want content solutions that enable them to design personalised learning experiences that are tailored particularly to the interests of each employee. SkillMonde offers businesses end-to-end services that are customised to their specifications & business line in order to guarantee that the content they produce is of the greatest calibre and satisfies all of their needs. We oversee the entire project in accordance with the highest industry standards to guarantee quality in delivery.
                            </p>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/custompage/corporate.blade.php ENDPATH**/ ?>