...
} elseif ($_instance->childHasBeenRendered('poI9o1S')) {
    $componentId = $_instance->getRenderedChildComponentId('poI9o1S');
    $componentTag = $_instance->getRenderedChildComponentTagName('poI9o1S');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('poI9o1S');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('poI9o1S', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://store.localhost/skillmonde/riverr_1_3_3/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
  ...
  <?php /**PATH D:\Server\htdocs\skillmonde\riverr_1_3_3\resources\views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>