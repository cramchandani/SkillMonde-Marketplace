...
} elseif ($_instance->childHasBeenRendered('jKXbIMK')) {
    $componentId = $_instance->getRenderedChildComponentId('jKXbIMK');
    $componentTag = $_instance->getRenderedChildComponentTagName('jKXbIMK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jKXbIMK');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('jKXbIMK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('b4iothS')) {
    $componentId = $_instance->getRenderedChildComponentId('b4iothS');
    $componentTag = $_instance->getRenderedChildComponentTagName('b4iothS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('b4iothS');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('b4iothS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://store.localhost/skillmonde/riverr_1_3_3/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH D:\Server\htdocs\skillmonde\riverr_1_3_3\resources\views/livewire/main/layout/app.blade.php ENDPATH**/ ?>