...
} elseif ($_instance->childHasBeenRendered('RxAUwnU')) {
    $componentId = $_instance->getRenderedChildComponentId('RxAUwnU');
    $componentTag = $_instance->getRenderedChildComponentTagName('RxAUwnU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RxAUwnU');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('RxAUwnU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('H63NDDL')) {
    $componentId = $_instance->getRenderedChildComponentId('H63NDDL');
    $componentTag = $_instance->getRenderedChildComponentTagName('H63NDDL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('H63NDDL');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('H63NDDL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\Server\htdocs\skillmonde\riverr_1_3_3\resources\views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>