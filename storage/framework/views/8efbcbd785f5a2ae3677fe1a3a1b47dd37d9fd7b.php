<div class="w-full container sm:px-2 md:px-4 lg:px-6">
	...
	<div class="rounded-xl px-8 pt-2.5 lg:min-h-[530px] md:bg-[120%] xl:bg-[100%] bg-white shadow-sm border border-gray-100 bg-contain bg-no-repeat  relative mx-auto dark:bg-zinc-800 dark:border-transparent lg:bg-[image:var(--projects-image-url)]" style="--projects-image-url: url(<?php echo e(url('public/img/assets/project-20230905102649yBKb.png')); ?>);">
...
<?php $__env->stopPush(); ?><?php /**PATH /home/skillmonde/public_html/resources/views/livewire/main/explore/projects/projects.blade.php ENDPATH**/ ?>